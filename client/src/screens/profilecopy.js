                              ...
                              {visitedUserId === loginuserId ? (
                                ...
                                {followersId.includes(loginuserId) ? (
                                  ...
                                  borderColor:"gray",backgroundColor:"white",borderRadius:"5px",marginLeft:"40px"}}  >Following</button>
                                    ...
                                    borderColor:"gray",backgroundColor:"white",borderRadius:"5px",marginLeft:"40px"}}  onClick={()=> dispatch(followUser(cUser))} >Follow</button>
                                )}
                          ...
                          <div style={{display:"flex",marginTop:"10px",}}>
                              ...
                              <p style={{marginLeft:"30px"}}>
                                  <button onClick={() => handleShow("followers")}
                                   style={{outline: "none",backgroundColor:"white",border:"none",fontWeight:"600"}}>{ cUser &&  cUser[0].followers.length} </button>followers</p>
                              <p style={{marginLeft:"30px"}}><button onClick={() => handleShow("following")}  
                              style={{outline: "none",backgroundColor:"white",border:"none",fontWeight:"600"}}>
                 ...
                 <div>
                     {cUser && cUser[0].following && cUser[0].following.map((item,index) =>(
                            ...
                            <div className="row">
                                ...
                                <div className="md-col-3 ml-1" style={{marginLeft:"200px",marginTop:"10px"}}>
